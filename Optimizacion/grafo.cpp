...
void GRAFO::ComparativaCM()
{
  ...
  cin >> s;
  cout << "Resultado del algoritmo de Dijkstra. " << endl;
  Dijkstra_(comparacionesDijkstra, s-1);
  cout << "Comparaciones Dijkstra: " << comparacionesDijkstra << endl;
  cout << endl;
  cout << "Resultado del algoritmo de Bellman Ford End. " << endl;
  BellmanFordEnd_(comparacionesBellmanFord, s-1);
  cout << "Comparaciones Bellman-Ford: " << comparacionesBellmanFord << endl;
  cout << endl;
  cout << "El algortimo general basado en la condicion de optimalidad, Bellman Ford End, ha realizado " << endl;
  cout << comparacionesBellmanFord/comparacionesDijkstra << " veces más comparaciones para mejorar la etiqueta distancia de dijkstra." << endl;
  cout << endl;
}
